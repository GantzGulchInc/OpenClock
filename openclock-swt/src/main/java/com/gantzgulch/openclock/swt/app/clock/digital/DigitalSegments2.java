...
public class DigitalSegments2 extends Composite {

	private static final GGLogger LOG = GGLogger.getLogger(DigitalSegments2.class);
	...
	public DigitalSegments2(final Composite parent, //
